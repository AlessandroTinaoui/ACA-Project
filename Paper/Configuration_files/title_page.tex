...
\hspace{-0.6cm}\includegraphics[width=0.6\textwidth]{logo_polimi_ing_indinf}

\vspace{-1mm}
\Large{\textbf{\color{bluePoli}{\title}}}\\

\vspace{-0.2cm}
\fontsize{0.3cm}{0.5cm}\selectfont \bfseries \textsc{\color{bluePoli} Course Project in \\ \course}\\
