#!/usr/bin/env python3
"""gem5 stdlib configuration for the MLP RISC-V SE demo with L1+L2 caches."""
...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Run the MLP RISC-V binary in gem5 SE mode with L1+L2 caches."
    )
    parser.add_argument(
        "--binary",
        default="build/riscv/mlp_demo_riscv",
