#!/usr/bin/env python3
"""gem5 stdlib configuration for the KAN RISC-V SE demo with only L1 caches."""
...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Run the mini KAN RISC-V binary in gem5 SE mode with L1 caches only."
    )
    parser.add_argument(
        "--binary",
