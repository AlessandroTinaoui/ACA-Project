#!/usr/bin/env python3
"""Build a compact markdown comparison for NASA fp32/PTQ/true-int runs."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Compare NASA fp32, PTQ, and true-int runs.")
